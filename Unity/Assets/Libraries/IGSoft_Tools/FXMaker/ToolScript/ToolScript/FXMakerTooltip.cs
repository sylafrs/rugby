...
*/
	...
	public static string GetHsEditor_NcParticleSpiral(string caption)
	{
		...
		switch (caption)
		{
			...
			case "Select ParticlePrefab":		tooltip	= HsEditor_NcParticleSpiral[GetLang(), 2];		break;
			case "Clear":						tooltip	= HsEditor_NcParticleSpiral[GetLang(), 3];		break;
			case "Open":						tooltip	= HsEditor_NcParticleSpiral[GetLang(), 4];		break;
