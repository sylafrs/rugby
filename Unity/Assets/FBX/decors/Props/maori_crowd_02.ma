...
//Name: maori_crowd_02.ma
//Last modified: Tue, Jun 11, 2013 12:29:51 AM
//Codeset: 1252
requires maya "2012";
...
createNode mesh -n "jap_crowdShape" -p "jap_crowd";
	...
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".pv" -type "double2" 0.25674451887607574 0.51307570209851849 ;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
	setAttr -s 4 ".uvst[0].uvsp[0:3]" -type "float2" -0.0055231154 0.37539271
		 0.50758147 0.35552669 0.0059078336 0.67062473 0.51901215 0.65075815;
	setAttr ".cuvs" -type "string" "map1";
	setAttr ".dcc" -type "string" "Ambient+Diffuse";
	setAttr -s 4 ".pt[0:3]" -type "float3"  35.424171 -9.7383499 -33.141052 
		35.424171 -9.7383499 -21.880222 35.424171 -9.7383499 -33.141052 35.424171 -9.7383499 
		-21.880222;
